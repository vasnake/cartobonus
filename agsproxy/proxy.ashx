...
public class proxy : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        //get legend
        // http://vdesk.algis.com/agsproxy/Proxy.ashx?
        // http://www.arcgis.com/sharing/tools/legend?soapUrl=http://wrngis1.algis.com/ArcGIS/rest/services/gencache/MapServer&f=json&returnbytes=true&_ts=634595883213349815
        // {"error":{"code":500,"message":"Unable to generate legends: HTTP status code {302 - Found} received from server"}}
        if(uri.StartsWith("http://www.arcgis.com/sharing/tools/legend")) {
            context.Response.ContentType = "text/plain";
            context.Response.Write("{\"error\":{\"code\":500,\"message\":\"Unable to generate legends: HTTP status code {302 - Found} received from server\"}}");
            return;
        }
